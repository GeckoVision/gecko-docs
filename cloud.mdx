...
correct as it drifts, and turn more correct calls into more usage (and, wired to their
...
<CardGroup cols={2}>
  ...
  <Card title="Run the free engine now" icon="terminal" href="/quickstart">
    `uvx --from "gecko-surf[serve]==0.4.1" gecko <spec>` runs the whole engine on your machine today.
  </Card>
</CardGroup>
