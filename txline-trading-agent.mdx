...
<Steps>
  ...
  <Step title="Agent settles the market on TxLINE's Merkle proof — the wallet signs">
    The comprehended TxLINE surface is **anti-poisoning-checked** — a manipulated tool is
    quarantined at comprehension, before the agent ever sees it. The agent maps the 3-stage
