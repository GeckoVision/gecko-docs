...
**What this shows:** the same instruction, predicted exactly, eleven times across two days
and two different account states. **What it does not show:** breadth. This is one program.
[The program surface](/program-surface) is where that claim is made and measured
separately.
