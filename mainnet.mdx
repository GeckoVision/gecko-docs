...
**Fifteen transactions. Fifteen exact predictions.**
...
**What this shows:** one instruction, predicted exactly, fifteen times across three days,
two storefronts and several account states — the last four with no key on the planning
machine.
